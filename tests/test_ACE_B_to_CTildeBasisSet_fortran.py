...
def test_BBasisFunctionSpecification_autocompletion():
    ...
    bfuncspec = BBasisFunctionSpecification(
        ["Al", "Al", "Al"], ns=[6, 6], ls=[5], coeffs=[1]
    )  # ls==[5,5]
    print(bfuncspec)
    ...
    ls = [4, 3, 1]
    bfuncspec = BBasisFunctionSpecification(
        ["Al", "Al", "Al", "Al"], ns=ns, ls=ls, coeffs=[1]
    )  # LS=[ls[-1]]
    print(bfuncspec)
    ...
    ls = [2, 2, 2, 0]
    bfuncspec = BBasisFunctionSpecification(
        ["Al", "Al", "Al", "Al", "Al"], ns=ns, ls=ls, LS=[2], coeffs=[1]
    )  # LS[-2]==LS[-1]
    print(bfuncspec)
    ...
    ls = [2, 2, 2, 2, 0]
    bfuncspec = BBasisFunctionSpecification(
        ["Al", "Al", "Al", "Al", "Al", "Al"], ns=ns, ls=ls, LS=[2, 2], coeffs=[1]
    )  # //L(-1) = l(-1)
    # LS==[2,2, 0]
    print(bfuncspec)
...
def test_BBasisFunctionSpecification_exceptions():
    with pytest.raises(ValueError) as exc:
        b = BBasisFunctionSpecification(["Al", "Al"], ns=[0], ls=[0], coeffs=[1.0, 2])
    print(str(exc.value))
    ...
    with pytest.raises(ValueError) as exc:
        b = BBasisFunctionSpecification(
            ["Al", "Al", "Al"], ns=[1, 1], ls=[0, 0], LS=[1], coeffs=[1.0, 2]
        )
    print(str(exc.value))
    ...
    with pytest.raises(ValueError):
        b = BBasisFunctionSpecification(
            ["Al", "Al"], ns=[1, 1], ls=[0, 0], LS=[1], coeffs=[1.0, 2]
        )
    print(str(exc.value))

    with pytest.raises(ValueError):
        b = BBasisFunctionSpecification(
            ["Al", "Al", "Al"], ns=[1, 1], ls=[0], LS=[1], coeffs=[1.0, 2]
        )
    print(str(exc.value))
