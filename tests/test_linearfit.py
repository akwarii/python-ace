...
bconf = create_multispecies_basis_config(
    potential_config={
...
bconf2 = create_multispecies_basis_config(
    potential_config={
        "deltaSplineBins": 0.001,
        "elements": ["Al", "Ni"],
        "embeddings": {
        ...
        "functions": {
            # "number_of_functions_per_element": 1000,
            "ALL": {"nradmax_by_orders": [6, 2, 1], "lmax_by_orders": [0, 2, 1]}
        },
    }
)
...
def test_LinearACEFit():
    ...
    print("errors=", errors)
    ref_errors = {
        "epa_mae": 0.003831128214766918,
        "epa_rmse": 0.005182476661323097,
        "f_comp_mae": 0.0012976990221506717,
        "f_comp_rmse": 0.0035144969263983432,
    }
